...
2. [Variables المتغيرات](#variables)
3. [Functions المهام](#functions)
4. [Objects and Data Structures الكائنات وهياكل البيانات](#objects-and-data-structures)
5. [Classes الطبقات](#classes)
6. [SOLID صلب](#solid)
7. [Testing اختبارات](#testing)
8. [Concurrency التزامن](#concurrency)
9. [Error Handling معالجة الأخطاء](#error-handling)
10. [Formatting تنسيق](#formatting)
11. [Comments تعليقات](#comments)
12. [Translation الترجمة](#translation)
...
[_Clean Code كود نظيف_](https://www.amazon.com/Clean-Code-Handbook-Software-Craftsmanship/dp/0132350882),
تتكيف مع JavaScript. هذا ليس دليل أسلوب. إنه دليل للإنتاج
[readable, reusable, and refactorable يمكن قراءتها وإعادة استخدامها وإعادة تصنيعها](https://github.com/ryanmcdermott/3rs-of-software-architecture) برنامج JavaScript.
...
يزيد عمر مهنتنا في هندسة البرمجيات عن 50 عامًا ، ونحن كذلك
لا يزال يتعلم الكثير. عندما تكون هندسة البرمجيات قديمة قدم الهندسة
في حد ذاته ، ربما عندها سيكون لدينا قواعد أصعب يجب اتباعها. الآن ، دع هؤلاء
...
مطور برامج ، والعمل معهم لسنوات عديدة لا يعني أنك لن تصنع
اخطاء. يبدأ كل جزء من الكود كمسودة أولى ، مثل الحصول على الطين الرطب
تتشكل في شكلها النهائي. أخيرًا ، نقوم بإزالة العيوب عندما
نراجعها مع أقراننا. لا تضغط على نفسك بسبب المسودات الأولى التي تحتاجها
تحسين. تغلب على الكود بدلا من ذلك!

## **Variables المتغيرات**

### استخدام أسماء المتغيرات ذات المعنى
**سيئ:**
...
**[⬆ عد إلى الأعلى](#table-of-contents)**
...
سنقرأ كود أكثر مما نكتبه في أي وقت مضى. من المهم أن رمز نحن
هل الكتابة قابلة للقراءة والبحث. من خلال _not_ تسمية المتغيرات التي تنتهي
كوننا ذا مغزى لفهم برنامجنا ، فإننا نؤذي قرائنا.
اجعل أسماءك قابلة للبحث. أدوات مثل
[buddy.js](https://github.com/danielstjules/buddy.js) and
[ESLint](https://github.com/eslint/eslint/blob/660e0918933e6e7fede26bc675a0763a6b357c94/docs/rules/no-magic-numbers.md)
يمكن أن تساعد في تحديد الثوابت غير المسماة.
**سيئ:**
...
**[⬆ عد الى الاعلى](#table-of-contents)**
...
**[⬆ عد الى الأعلى](#table-of-contents)**

### لا تقم بإضافة سياق غير ضروري

إذا أخبرك اسم الفصل / الكائن بشيء ما ، فلا تكرره في ملف
اسم المتغير.
...
### استخدم الوسيطات الافتراضية بدلاً من الدوائر القصيرة أو الشرطية

غالبًا ما تكون الحجج الافتراضية أنظف من قصر الدائرة. كن على علم أنه إذا كنت
استخدمها ، ستوفر وظيفتك القيم الافتراضية لـ "غير محدد" فقط
الحجج. قيم "falsy" أخرى مثل "" `،" "" `،` false` ، `null` ،` 0` ، و
لن يتم استبدال `NaN` بقيمة افتراضية.
